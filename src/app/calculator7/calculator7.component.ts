  ...
  ScoreSubmit() {
    ...
    console.log(this.formGroup.value);
      ...
      if (this.formGroup.value.score2 == "Patients with HIT")
      {
        ...
        this.content2 = "After the initiation of Argatroban Injection, adjust the dose (not to exceed 10 mcg/kg/min) as necessary to obtain a steady-state aPTT in the target range.";
      } else
      {
        this.head1 = "Monitoring Therapy";
        this.content1 = "For use in PCI, therapy with Argatroban Injection is monitored using ACT. Obtain ACTs before dosing, 5 to 10 minutes after bolus dosing, following adjustments in the infusion rate, and at the end of the PCI procedure. Obtain additional ACTs every 20 to 30 minutes during a prolonged procedure.";
        this.head2 = "Continued Anticoagulation after PCI";
        this.content2 = "If a patient requires anticoagulation after the procedure, Argatroban Injection may be continued, but at a rate of 2 mcg/kg/min and adjusted as needed to maintain the aPTT in the desired range.";
      }
    
      if (this.formGroup.value.score2 == "Patients with HIT" || this.formGroup.value.score2 == "Patients Undergoing PCI" && this.formGroup.value.score4 == "Yes" )
      {
        this.bolus_dose = 0;
        this.bolus_vol = 0;
        ...
        this.infusion_rate = 60 * 0.5 * parseInt(this.formGroup.value.score1) * 250 / 1000 * 250;
      ...
      } else
      {
        ...
        // console.log(this.infusion_dose);
        // this.infusion_dose.toFixed();
        this.infusion_rate = 60 * 2 * parseInt(this.formGroup.value.score1) * 250 / 1000 * 250;
        this.infusion_rate = Math.round(this.infusion_rate)
      }

      if (this.formGroup.value.score2 == "Patients Undergoing PCI" && this.formGroup.value.score3 >300 && this.formGroup.value.score3<400 && this.formGroup.value.score4 == "No")
      {
        ...
        // console.log(this.infusion_dose);
        // this.infusion_dose.toFixed();
        this.infusion_rate = 60 * 25 * parseInt(this.formGroup.value.score1) * 250 / 1000 * 250;
        this.infusion_rate = Math.round(this.infusion_rate)
      }
      else if (this.formGroup.value.score2 == "Patients Undergoing PCI" && this.formGroup.value.score3 <300  && this.formGroup.value.score4 == "No")
      {
        ...
        // console.log(this.infusion_dose);
        // this.infusion_dose.toFixed();
        this.infusion_rate = 60 * 30 * parseInt(this.formGroup.value.score1) * 250 / 1000 * 250;
        this.infusion_rate = Math.round(this.infusion_rate)
      }
      else
      {
        ...
        // console.log(this.infusion_dose);
        // this.infusion_dose.toFixed();
        this.infusion_rate = 60 * 15 * parseInt(this.formGroup.value.score1) * 250 / 1000 * 250;
        this.infusion_rate = Math.round(this.infusion_rate)
      }
